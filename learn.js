...
// /* arrow function using this keyword pointing to the window so it not recomend to use in local scope   but normal function pointing to the it's outer function object in local scope */
...
// /* Object: Is a collection of property and property is association of name and value  A cup is an object, with properties.
...
Successful Response:
200 : ok for get/head/put or post/trace
201:created
202: accepted
...
// const a = [32, 2, 4, 32, 45, 23, 56, 21, 454, 6321, 43, 'A', 'B', 'c', 'd', 1, 2, 4, 32, 45, 23, 56, 21, 454, 6321, 43, 1, 2, 4, 32, 45, 23, 56, 21, 454, 6321, 43, 'A', 'B', 'c', 'd']
// const itr = a.entries() // return iterator
